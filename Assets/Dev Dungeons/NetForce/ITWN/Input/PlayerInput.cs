...
namespace NetForce
{
    ...
    ""controlSchemes"": []
        ...
        ~@PlayerInput()
        {
            UnityEngine.Debug.Assert(!m_CharacterActions.enabled, "This will cause a leak and performance issues, PlayerInput.CharacterActions.Disable() has not been called.");
        }

...
namespace FreeParking.Bootstrap
{
    ...
    ""controlSchemes"": []
        ...
        ~@InputGlobalActions()
        {
            UnityEngine.Debug.Assert(!m_GlobalActionsMap.enabled, "This will cause a leak and performance issues, InputGlobalActions.GlobalActionsMap.Disable() has not been called.");
        }
